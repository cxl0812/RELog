...
parser.add_argument('-l', '--load', type=str, default=None, help='load the saved mainModel, not load if not specified, default: None')
parser.add_argument('-s', '--save', type=str, default=None, help='save the mainModel in this running, not save if not specified, default: None')
parser.add_argument('-ep', '--epoch', type=int, default=10, help='epochs, , default: 10')
parser.add_argument('-lr', '--learn_rate', type=float, default=1e-4, help='initial learning rate, default: 1e-4')
parser.add_argument('-lrd', '--learn_rate_decay', type=float, default=0.9, help='learn rate decay, per 5 epochs, default: 0.9')
parser.add_argument('-rr', '--replace_rate', type=float, default=0, help='replace rate of dataset, during random replace pretrain process, default: 0')
parser.add_argument('-rn', '--replace_cnt', type=int, default=4, help='replace log line count of each replaced seq, during random replace pretrain process, default: 4')
parser.add_argument("-d", "--dataset", default="BGL", type=str, help='dataset name, "BGL" or "HDFS", default: "BGL"')
parser.add_argument('-ar', '--abnormal_rate', type=float, default=0, help='abnormal rate in the train dataset, do not adjust if value is 0, default: 0')
parser.add_argument('-air', '--abnormal_interval_rate', type=float, default=0, help='add abnormal interval rate, 0 if not specified, default: 0')
parser.add_argument('-apr', '--abnormal_param_rate', type=float, default=0, help='add abnormal param rate, 0 if not specified, default: 0')
parser.add_argument("-mini", "--mini", default=False, action='store_true', help='whether use the mini dataset, default: False')
parser.add_argument("-normal", "--normal", default=False, action='store_true', help='whether use the pure normal dataset, default: False')
parser.add_argument("-abnormal", "--abnormal", default=False, action='store_true', help='whether use the pure abnormal dataset, default: False')
parser.add_argument("-np", "--no_param", default=False, action='store_true', help='do not use the paramEncoder, default: False')
parser.add_argument("-ni", "--no_interval", default=False, action='store_true', help='do not use the intervalEncoder, default: False')
parser.add_argument("-nle", "--no_logEncoder", default=False, action='store_true', help='do not use the logEncoder, default: False')
parser.add_argument("-nfz", "--not_freeze", default=False, action='store_true', help='do not freeze the logEncoder(not freeze when random replace pretrain, and freeze when finetune), default: False')
parser.add_argument("-not_random_pretrain_normal", "--not_random_pretrain_normal", default=False, action='store_true', help='(not used in formal training) whether random the normal sample when pretrain, default: False')
parser.add_argument('-ter', '--template_evolution_rate', type=float, default=0, help='add template evolution rate, 0 if not specified, default: 0')
parser.add_argument('-spe', '--max_step_per_epoch', type=int, default=0, help='max step pre epoch, 0 if not specified, to indicate unrestricted (used when the dataset is too huge), default: 0')
